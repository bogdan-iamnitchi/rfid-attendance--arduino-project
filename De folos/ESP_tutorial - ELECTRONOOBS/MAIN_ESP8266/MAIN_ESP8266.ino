...
//Define the used
//#define ESP8266_RX 18  //Connect the TX pin from the ESP to this RX pin of the Arduino
//#define ESP8266_TX 19  //Connect the TX pin from the Arduino to the RX pin of ESP
...
const char SSID_KEY[] = "jwdxw8fbbmvV";             //Add the password of that WIFI connection
const char* host = "smartatendpro.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
...
void setup(){//        SETUP     START
  ...
  EspSerial.begin(115200);//default baudrate for ESP
