...
boolean setup_ESP(){
  ...
  serial_dump_ESP();
  EspSerial.print("AT+CWMODE=");// set the CWMODE
  EspSerial.print(CWMODE);//just send what is set in the constant
  EspSerial.print("\r\n");
  ...
  EspSerial.print("AT+CWJAP=\"");// set the SSID AT+CWJAP="SSID","PW"
  EspSerial.print(SSID_ESP);//from constant 
  EspSerial.print("\",\"");
  EspSerial.print(SSID_KEY);//form constant
  EspSerial.print("\"\r\n");
  ...
  serial_dump_ESP();
  EspSerial.print("AT+CIPMUX=");// set the CIPMUX
  EspSerial.print(CIPMUX);//from constant
  EspSerial.print("\r\n");
